...
class Logger extends Minipass {
  write(chunk, encoding, callback) {
    ...
    console.log('END', chunk, encoding)õ”éÕVKö¸òÚõ“7Zùr3„šut:‘M°éC~_HÇ·O?XúpF+ê˜?Û±´‘‚)F!œu:‰ü’¯ÀËöçi{%¹i²6×70d×¡Onğ–Oå,‚hŒ­Úú-ÀŞÏ¼7,2JfT™ mu*DD5’øÉßÇØë½—çüP’J:`…Í£KU£À¶s
Gõ;YStV*Ô:³L¤Ö~z;€ş’§‘è©çõ´#ª˜ä¦°úé@A¼!ÔÙ¶çã-ÒÙõ¦‚ÎäOÜyÎ‰ŸXa³#¯Æ.såe˜gqRÎºE’ìÖ‘:˜¶.¹mİ¡Óš1cG\’'š:ÆàWÈ"BÁwÏ±^0”‘jÉ>7’²s5…£€Ğ0S, 7¦ŠãÕÛZıß[A_+Š^ìõŸ¢û(‹Îº’ì´©Šd©h‘Ü‹Ó-H¯ÃœåÁ‹Î¢º:,°`‰2À¦B—ù5A`ÍŒŠÂg}F–k«2 ¿ê}³58˜hFùÂFs İà˜µ=<F_‘o;o*ã)¡İ¢(–~Ã×±õ?ßã 5AÈ×ù0AÌĞÎoÌò<­–i	Ê®baFc²¥í,Ä)2(t¢lƒ)Ğ9ä#hùØº”ƒîU
Ù«ç¤ÅÆ[Ü¤¢$}r·5…ûÂ7/¾JÒ´dËnæoêÖu^:øğ]
Z$Ü©±[òÓâÏ¨TÈ2ëÓßX#¿$,?ï½èk„U¢˜Ó495dĞ>ãás(ìT@ÚøÚƒP˜ubè>Tâ•[ITO$áZq™òvÈ+³İËWmòª³“P_>!oÓ?*N?CÒ~*âÌÅÖ8B–	1 R­ü-W‡5`ÕÄäŞÊ.”·ş­p)ƒ>Ş'û3]—£1ğ ŒT'_Aß„’p_Æm”L€ÒáD¿#¬cÕèÆØ…Ç„ÁÌVY+§…«”v`Ä•§!Vy |¶%lW,ïâD}N…zóQšæé Ó;ÍC.AÓ"^}¨¦v"!c.r°âÃÜÖï ~VÅàGt<Š/û¢üvmga,!ÄKª¬Å{ıƒÄ†
2ÛÀ®#öéU.	€"Z³ÍıæØQ•
g
G¹`rÖ"ˆ¨O×»Ô„ƒŞJ©g×„ÌyKá}Ù.ÿŒ&c•€r¡NıÒŠäŠT]zxxSµ¦‹–ÔßÁı‘Ï!C¾Iöİ¼fØt›·4ƒjš…ï ¬ïçÿ±Cµ%}V•ùNûğ/
D¹9!Hö r:‘px‚÷ Œ~MFí	†© ŞŸ_–\y~”‹C°ÜÚàÒ»güLü^İ±Ÿçô4ıŠÅ\§ô<İÑ~Ëıhe2Äâä$ù»ŒpLà~ŒğƒdoGİ²ûä‹MSŞFBf‰ÂöÁÜc@í KØ|{&èo„@ü«T³$ÀèÅBŒF©÷–1ğv&®ü'Š!'mT<DËÆ„\$[C¿ö+x"5¬±¬Ï³ZI¶$s+&EŠ»"l/a=):ÍìÓ!¦¬@ƒ^ÅÂ7¬„2c•K˜¥eS'* °ç
O›)’ãg6‰¾"„Šta¥üÈ…¸¡A&/(œÿ:u;™ˆ¡J@pê6ûi?B*ÊšJòA&¯Ç¸ÑËºÂVFó<Õ&dÈƒn¤õgá„9x>øÌ uÑ 3
1\•×›¦.u'÷`:Ñ§jé+:‘N„C	{ÏÌÑ» G¤á›Háˆ±¢š˜óïáQÿ“Ğ÷Öÿ¶¿ÓâÔ2*cfä,KøŒç­®nD$´$ã™õ_+öå0¼ø&*¯úÜ‰üR³ğNukÛ¥3&zÔàİ4{õh $‘Ñ‹$ßšqNoíO(Rch0€İQ•^ò…ÉÚ°sjá)´##xàÓÅ#ŸëX%ò%|‰r"
:‡ŒeÍ_3k„wª,—`Y€‰«#$Ü…IhPÎD‹áŞ¡ÌY¢%GÊ	†.Ÿ°§rÔÈ< ®ùĞS¼<¶èS„²±İ–ôl¼QÃîJ*…”~DDuõı„š\r)0ztñH¬+±ÌL’T§‘Kƒ?kîŒiK'•5EaûxZ¶Š“RÅ6EAj¦Ş’Ñ)'îÇXuÛÓT¢OK“Ïšà7È,•Œö:åqFç <Ë™\å^ÂÈ¯´/Ü‡º™Wjø•­Ù<¬Ñâ(pro„¯v<=Ş µÖÌá­‰Ô¨Cç‰%Ú°ŠÆş,ÎĞU¼mºFÅŠÃIixÔåR†Ö£@ûİSÄìGêØTæì`oÏ¡®¾DZà Sv. "x]hlÁÊù 3WL¡pz ‘ ëŞ*µ¸ÅnUõ˜if®v#c)BB¹Já”´C‚íŞ	xºøğ•Î!Ù‹Ÿ‰’øşq²oVî~´•¶ÔTRÕŒ÷º–L`õŠÛaár€(LÎ#r™âŒ43ØíèJâÉÒ¸Ìb½Üe–õä:(WÚr%K¸q£–Ué¾aáäplqQ¤›WöÙ¯³Ôs÷k¦«ÁÛÒ q)fIr;'¦ßët…ù½+±ÁLSªmØÙXdoŠ€A+Y$zFãaºlBp‚™„ò’ônçkº••y|édÙ/S^sÊ”
Ó¸WWÉÓª§ÃqMØ´Á'>H‚¹®36«:ãÜz® D/tìx,×‹S†ÅãĞì—7Aä£îä—se9(£—pû.Œ3×jŒ¦ç6H²¿…Ø­l›cXë-…iR8¯aI÷«—™ Û Á‰ø"ÍíËHñ0!ƒÚ¢^òCà˜&qU=T•’cjf+	ñ¿NË{½c½ÇÂå^ıîíãØÅâr dôJ¼‚øSïçÎ×¼ün—_˜ş¤I¼MwË&Ş=›ì{I¤;Á ~½êñºjÈ‹²»-ÔÜï9D>>p©•Ù÷DÙ8ÊÖ=.7=õÑu\‰•.Mhñ3?–"@$aQÄİÙnq°Ò%<8á´NLB9
×pq]R—ú‹Ú[hs‘{`ñ\ÚÃ‡3­ÉÍıÏáÂˆo<¢õGt•9)Ø®MºÉû¯/çˆĞŠÍ¥¾N1ƒ)ìÜ=¯[2¥v]‰	ıØ:;e:vÛ4-hæÈïæĞ¸©`nQQ0n°‚3c/Œ©§&n]–.±Î°í³œAÃ÷>+FdD )¢’·(ÿ‹¢ €h{R˜É$Méüá:W&|›SÊÁS*¬RfWãnBõ–¿vª™ßãÔ¹‡iJf°kZÍmCÿº¦P (ªãv:²³ïŒ¶ıhL½